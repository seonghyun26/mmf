...
class FingerprintManager:
    ...
    def get_pretrained_fingerprints(self, molecules):
        if self._check_cache(self.cfg.pretrained.kind):
            cache_path = os.path.join(self.cfg.cachedir, self.cfg.pretrained.kind, self.taskname, f"{self.split}.pkl")
            with open(cache_path, "rb") as f:
            ...
            self._save_cache(self.cfg.pretrained.kind, fingerprints_pretrained)
