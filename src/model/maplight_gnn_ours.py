...
class MaplightOurs(ModelWrapper):
    ...
    def pretrain(self):
        results = {}
        pretrain_task = self.cfg.model.pretrain.task
        # TODO: pretrain encoder with tasks other than ADMET
    ...
    def train(self):
        ...
        for seed in tqdm(range(self.cfg.job.max_seed)):
            plot_file = f"{plot_dir}/{seed}.html"
